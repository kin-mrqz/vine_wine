...
# === Category List ===
product_categories = [
    "bordeaux", "burgundy", "alsace", "loire", "rhone", "jura",
    "vintage-champagne-en", "non-vintage-champagne-en", "blanc-de-noirs-champagne-en",
    "blanc-de-blancs-champagne-en", "rose-champagne-en", "veneto", "piedmont", "toscana",
    "sicily", "italy-other-region", "amarone", "barbera", "barolo", "barbaresco", "nebbiolo",
    "chianti", "brunello-di-montalcino", "prosecco", "austria", "german", "hungary", "portugal",
    "spain", "old-world-other-region", "argentina", "australia", "chile", "china", "new-zealand",
    "south-africa", "usa", "new-world-other-region"
]
seen_links = set()
...
# Functions for getting summary elements of each wine
...
# Loop through categories and collect product links 
